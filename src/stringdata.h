...
namespace bson {
    ...
    public:
        ...
        // the string is already known. 'c' must be a pointer to a
        // null-terminated string, and strlenOfc must be the length that
    ...
    private:
        ...
        // These assumptions may make it easier to minimize changes to existing
        // code.
